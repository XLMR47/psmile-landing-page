...
export default function SmartSection({ jugadorId, isAdmin }) {
    ...
    const [showNuevaMeta, setShowNuevaMeta] = useState(null); // id de dimension
    ...
    const handleCrearMeta = async (dimId) => {
        ...
        try {
            ...
            setMetas(prev => ({ ...prev, [dimId]: { ...data, id: docRef.id, createdAt: { toDate: () => new Date() } } }));
            setNuevaMetaTxt('');
    ...
    const handleAddSeguimiento = async (dimId) => {
        ...
        try {
            ...
            const docRef = doc(db, 'metas_smart', meta.id);
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="mb-4">
                                    ...
                                    {meta ? (
                                        <p className="text-sm text-white font-bold leading-relaxed line-clamp-2 min-h-[40px]">
                                            {meta.meta}
                                        </p>
                                    ) : (
                            ...
                            {isOpen && (
                                <div className="px-6 pb-6 space-y-6 animate-in slide-in-from-top-2 duration-300 border-t border-white/5 mt-2 pt-6">
                                    {/* History Chart Placeholder / Visualization */}
                            ...
                            {/* Modals / Inline Forms - Portal-like behavior overlay */}
                                    ...
                                    <div className="bg-[#111827] border border-white/10 rounded-3xl p-8 max-w-lg w-full space-y-6 shadow-2xl animate-in zoom-in-95 duration-200">
                                        ...
                                        <div className="space-y-4">
                                            <p className="text-[11px] text-[#9CA3AF] leading-relaxed italic border-l-2 border-[#38BDF8] pl-3">
                                                Recuerda que una meta SMART debe ser Específica, Medible, Alcanzable, Relevante y con un Tiempo definido.
                                            </p>
                                            <textarea 
                                                value={nuevaMetaTxt}
                                                ...
                                                placeholder="Ej: Aumentar la velocidad de desplazamiento en 0.5s en los test de 20m antes del final del trimestre..."
                                            />
                                        </div>
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <textarea 
                                                    ...
                                                    placeholder="Detalla el progreso, dificultades o ajustes realizados..."
                                                />
                                            </div>
                                        </div>
